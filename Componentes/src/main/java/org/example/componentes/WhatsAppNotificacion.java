...
public class WhatsAppNotificacion implements InterfazNotificacion {

    @Override
    public void enviar(Destinatario destinatario, Mensaje mensaje) {
        System.out.println("Enviando WhatsApp: " + destinatario.getTelefono() + " , Mensaje: " + mensaje.getCuerpoMensaje());
    }
