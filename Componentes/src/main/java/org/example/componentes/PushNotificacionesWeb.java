...
public class PushNotificacionesWeb implements InterfazNotificacion {

    @Override
    public void enviar(Destinatario destinatario, Mensaje mensaje) {
        System.out.println("Enviando pagina web: " + destinatario.getCorreo() + " , Mensaje: " + mensaje.getCuerpoMensaje());
    }
